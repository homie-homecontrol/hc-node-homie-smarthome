...
Base library for homie homecontrol based on [node-homie](https://github.com/homie-homecontrol/node-homie). This lib defines a set of standard smarthome nodes like switch, dimmer, weather sensor,...
